...
/**
 * Дефолтные настройки видео (AV1 NVENC)
 */
...
/**
 * Строит настройки видео из профиля кодирования или использует дефолтные
 *
 * @param encodingProfile - Профиль кодирования из БД
 * @param effectiveCq - Эффективное значение CQ (может быть переопределено VMAF)
 * @returns Настройки для транскодирования видео
 */
export function buildVideoOptions(
  ...
  // Дефолтные настройки с переданным CQ
  return {
